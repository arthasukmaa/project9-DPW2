                        ...
                        <ul class="cart_list">
                            <li class="cart_item clearfix">
                                <table class="table">
                                    ...
                                    <tr>
                                    <td><img src="{{url('public')}}/assets/images/product1.png" alt="/keranjang"/ width="30%"></td>
                                    <td>Keyboard</td>
                                    <td>Hitam</td>
                                    <td>57.000</td>
                                    ...
                                    <tr>
                                    <td><img src="{{url('public')}}/assets/images/product6.png" alt="#"/ width="30%"></td>
                                    ...
                                    <tr>
                                    <td><img src="{{url('public')}}/assets/images/product7.png" alt="/keranjang"/ width="30%"></td>
                                    <td>RAM Laptop</td>
                                    <td>Hitam</td>
                                    <td>300.000</td>
                                    <td><button class="btn btn-light"><i class="fa fa-minus" aria-hidden="true"></i></button>2 Unit <button class="btn btn-light"><i class="fa fa-plus" aria-hidden="true"></i></td>
                                    ...
                                    <tr>
                                    <td><img src="{{url('public')}}/assets/images/product8.png" alt="/keranjang"/ width="30%"></td>
                                    <td>Batry Laptop</td>
                                    <td>Hitam</td>
                                    <td>200.000</td>
                                    <td><button class="btn btn-light"><i class="fa fa-minus" aria-hidden="true"></i></button>2 Unit <button class="btn btn-light"><i class="fa fa-plus" aria-hidden="true"></i></td>
