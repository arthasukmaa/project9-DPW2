                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item d_none">
                                 <a class="nav-link" href="{{url('search')}}"><i class="fa fa-search" aria-hidden="true"></i></a>
                              </li>
      ...
      <div class="three_box">
         <div class="container">
            <div class="row">
               <div class="col-md-4">
                  <div class="box_text">
                     <i><img src="{{url('public')}}/assets/images/thr.png" alt="#"/></i>
                     <h3>Computer</h3>
               ...
               <div class="col-md-4">
                  <div class="box_text">
                     <i><img src="{{url('public')}}/assets/images/thr1.png" alt="#"/></i>
                     <h3>Laptop</h3>
                     <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box_text">
                     <i><img src="{{url('public')}}/assets/images/thr2.png" alt="#"/></i>
                     <h3>Tablet</h3>
                     <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                  </div>
               </div>
                     ...
                     <div class="row">
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product1.png" alt="/keranjang"/></figure>
                              <a href="{{url('keranjang')}}"><h3>masukan keranjang</h3></a>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product2.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product3.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product4.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product5.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product6.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product7.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product8.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="product_box">
                              <figure><img src="{{url('public')}}/assets/images/product9.png" alt="#"/></figure>
                              <h3>masukan keranjang</h3>
                           </div>
                        </div>
                        <div class="col-md-12">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="laptop_box">
                     <figure><img src="{{url('public')}}/assets/images/pc.png" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-9 offset-md-3">
                                       <div class="test_box">
                                          <i><img src="{{url('public')}}/assets/images/cos.png" alt="#"/></i>
                                          <h4>Sandy Miller</h4>
